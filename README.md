...
This module creates following resources on for VPC infra. We are using high availability, it considers first 2 avaiable zones automatically.
* It creates the following resources
* VPC
* Internet Gateway with VPC association
* 2 Public subnets in 1a and 1b zones
* 2 Private subnets in 1a and 1b zones
* 2 Database subnets in 1a and 1b zones
* Elastic IP creation
...
* VPC peering based on user request
